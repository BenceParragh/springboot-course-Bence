...
import hu.cubix.hr.bencepar.model.Company_;
import hu.cubix.hr.bencepar.model.Employee;
import hu.cubix.hr.bencepar.model.Employee_;
import hu.cubix.hr.bencepar.model.Position_;
...
public class EmployeeSpecifications {
	...
	public static Specification<Employee> hasEntryDate(LocalDateTime entryDate) {
		...
		return (root, cq, cb) -> cb.between(root.get(Employee_.startTimestamp), startOfDay, startOfDay.plusDays(1));
	}
