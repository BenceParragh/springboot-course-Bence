...
import hu.cubix.hr.bencepar.dto.HolidayRequestFilterDto;
...
import hu.cubix.hr.bencepar.security.HrUser;
...
public class HolidayRequestService {
	...
	public HolidayRequest approveHolidayRequest(long id, long approverId, boolean status) {
		...
		if(!holidayRequest.getEmployee().getManager().getId().equals(currentUser.getId()))
	...
	public void deleteHolidayRequest(long id) {
		...
		if(!employee.getId().equals(getCurrentHrUser().getEmployee().getId()))
